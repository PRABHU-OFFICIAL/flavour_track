...
class ClothingDonationForm extends StatefulWidget {
  const ClothingDonationForm({Key? key}) : super(key: key);

  @override
  _ClothingDonationFormState createState() => _ClothingDonationFormState();
}

class _ClothingDonationFormState extends State<ClothingDonationForm> {
